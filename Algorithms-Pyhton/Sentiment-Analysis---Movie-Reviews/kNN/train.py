...
path = '/home/rodriguesfas/Workspace/Text-Mining/Sentiment-Analysis---Movie-Reviews-master/kNN/'

stopwords = open(path+'stopwords.txt', 'r').read().splitlines()
dataset = open(path+'training_set.csv', 'r')
...
model = open(path+'model_file.csv', 'w')
...
testset = open(path+'test_set.csv', 'r')
testset.readline()

output = open(path+"prediciton_file.csv", 'w')
